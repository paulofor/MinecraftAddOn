...
3. acompanhar a população, incluindo citizens/villagers e os jogadores ativos;
4. registrar participação dos jogadores e responsabilidades por projeto, sem classes fixas;
...
- decisões coletivas;
- orçamento;
- participantes e responsabilidades por projeto;
...
Os jogadores cooperam livremente e podem assumir tarefas diferentes a cada sessão.

O add-on **não deve exigir classes fixas** como construtor, minerador ou fazendeiro. Em vez disso, deve permitir:
- participação aberta nas atividades da cidade;
- definição de responsáveis por obra, proposta ou distrito;
- cargos temporários opcionais quando fizer sentido para a governança.
...
7. registra os jogadores ativos;
...
## RF-02 — Jogadores e cargos temporários

O sistema deve registrar e consultar:
- jogadores ativos da cidade;
- responsáveis por obra, proposta ou distrito;
- prefeito (cargo temporário, opcional);
- tesoureiro (cargo temporário, opcional);
- conselho/juiz (cargo temporário, opcional).

O add-on **não deve depender de classes fixas** para funcionar.
...
- criação da cidade;
- criação de distrito;
- mudança de cargo temporário ou responsável;
- proposta aberta;
...
- nome;
- cenário;
- jogadores ativos e responsáveis atuais;
- população registrada;
- tesouro;
- obra prioritária;
- evento ativo;
...
- `/cidade`;
- setup inicial;
- jogadores ativos e responsáveis por projeto;
- estado da cidade;
- storage base;
- histórico base;
- logs base.
...
## CA-02 — Jogadores ativos

Dado o setup concluído,
quando os jogadores são registrados,
então o sistema salva os participantes ativos e os exibe no estado da cidade.
...
2. cargos temporários e responsáveis por projeto serão scoreboards, tags ou storage puro?
...
- jogadores cooperando sem papéis fixos;
