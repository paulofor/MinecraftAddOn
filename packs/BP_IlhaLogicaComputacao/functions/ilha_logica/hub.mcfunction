...
execute as @a[tag=!ilhlog_final] run tellraw @s {"rawtext":[{"text":"[IlhaLogica] Para ler melhor, mire na Lanterna/Lectern, use/interaja (botao direito, LT ou toque) e escolha Painel escuro de leitura."}]}
