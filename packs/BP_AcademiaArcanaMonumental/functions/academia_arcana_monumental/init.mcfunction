# Sprint 5 - Academia Arcana Monumental
...
title @s subtitle §fSprint 5: Observatorio, Jardins e Anfiteatro
tellraw @s {"rawtext":[{"text":"[AcademiaArcana] Execute /function academia_arcana_monumental/montar_completa em uma area livre para criar as Sprints 1 a 5 da Academia Arcana Monumental."}]}
