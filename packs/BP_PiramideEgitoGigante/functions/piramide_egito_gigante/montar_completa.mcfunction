...
execute unless score @s peg_bloqueio matches 0 run tellraw @s {"rawtext":[{"text":"[Piramide][TRAVA] Montagem bloqueada: agua/lava amostrada, jogador sem bloco sob os pes ou terreno sem apoio ate Y-8. Escolha area seca/desertica, com os pes no chao e longe de rios/oceanos, e execute novamente."}]}
