...
execute if score @s peg_bloqueio matches 0 run tp @s ~ ~90 ~
execute if score @s peg_bloqueio matches 0 run tellraw @s {"rawtext":[{"text":"[Piramide] Voce foi movido para cima da piramide para evitar sufocamento e facilitar a validacao visual."}]}
