...
tellraw @s {"rawtext":[{"text":"[Piramide] Execute /function piramide_egito_gigante/montar_completa em area seca, livre, e com os pes no chao no centro desejado. A obra ocupa X/Z ~121x121, prepara o terreno de Y-8 a Y+58 e limpa ate Y+70."}]}
